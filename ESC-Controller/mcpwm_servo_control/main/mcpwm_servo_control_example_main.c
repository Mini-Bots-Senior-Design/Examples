...
#define ESC_PULSE_GPIO             4        // GPIO connects to the PWM signal line
...
void app_main(void)
{
    ...
    while (1) {
        ...
        printf("PWM: 1000 microseconds\n");
        ESP_ERROR_CHECK(mcpwm_comparator_set_compare_value(comparator, 1000));
        vTaskDelay(2000 / portTICK_PERIOD_MS);

        printf("PWM: 1200 microseconds\n");
        ESP_ERROR_CHECK(mcpwm_comparator_set_compare_value(comparator, 1200));
        vTaskDelay(2000 / portTICK_PERIOD_MS);

        printf("PWM: 1400 microseconds\n");
        ESP_ERROR_CHECK(mcpwm_comparator_set_compare_value(comparator, 1400));
        vTaskDelay(2000 / portTICK_PERIOD_MS);

        printf("PWM: 1500 microseconds\n");
        ESP_ERROR_CHECK(mcpwm_comparator_set_compare_value(comparator, 1500));
        vTaskDelay(2000 / portTICK_PERIOD_MS);

        printf("PWM: 1600 microseconds\n");
        ESP_ERROR_CHECK(mcpwm_comparator_set_compare_value(comparator, 1600));
        vTaskDelay(2000 / portTICK_PERIOD_MS);

        printf("PWM: 1800 microseconds\n");
        ESP_ERROR_CHECK(mcpwm_comparator_set_compare_value(comparator, 1800));
        vTaskDelay(2000 / portTICK_PERIOD_MS);


        printf("PWM: 2000 microseconds\n");
